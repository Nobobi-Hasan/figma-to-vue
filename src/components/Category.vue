<template>
    ...
    ">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 place-items-center">       
            <div class="text-white grid place-items-center gap-5 text-center" v-for="category of categories" :key="category.id">
                <div class="p-10">
                    <img :src="category.image" alt="category-img" class="w-full">
                </div>
                <h3 class="text-3xl font-bold">{{ category.title }}</h3>
                <p class="w-3/4">{{ category.description }}</p>
            </div>      
        </div>
    ...
    <section id="about" class="grid grid-flow-col grid-cols-1 md:grid-cols-2 md:gap-10 items-center">
        ...
        <div class="text-center flex flex-col items-center">
            ...
            <div class="flex items-center gap-5">
                ...
                <img src="../assets/images/head2-img.png" alt="" class="w-9 md:w-12">
            </div>

            <p class="mt-8 md:mt-12 text-white text-lg md:text-xl w-[80%]">
                Halloween or Hallowe'en, also known
                as Allhalloween, All Hallows' Eve, or All Saints' Eve, is a celebration observed in many countries on 31
...
const categories = ref([
    {
        ...
        title: 'Ghost',
        image: category1,
        description: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Id id consequat, eu faucibus nulla. Ultrices mattis lacus, sed maecenas nascetur. ',
    },
    {
        id: 2,
        title: 'Witch',
