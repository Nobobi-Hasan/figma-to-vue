    ...
    <nav ref="navbar" class="fixed top-0 left-0 w-full bg-primary-200 z-20 transition duration-200">
        <div class="container flex items-center justify-between h-20">
            <div class="relative z-30 flex items-center gap-2 mb-2 lg:mb-3">
                ...
                <h1 class="text-white font-bold text-2xl md:text-3xl lg:text-4xl">Hallow<span class="text-secondary">ee</span>n</h1>
            ...
            :class="!showMenu ? 'translate-y-[-150%]' : '-translate-y-0'">
                ...
                <button class="hidden lg:block px-8 py-3 rounded-full text-white font-medium tracking-wider uppercase bg-secondary w-full lg:w-auto">Donate</button>
            </div>
